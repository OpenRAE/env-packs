...
- **It does not define scenario meaning.** The SDL and its semantics are
  [RAES](https://github.com/RAESystem/rae)'s. This project consumes them and adds
...
- **One maintainer.** This is a single-maintainer project. There is no support
  ...
  [SUPPORT](https://github.com/RAESystem/env-packs/blob/main/SUPPORT.md).
...
- **The contract still evolves.** The pack format is versioned. Breaking changes
  ...
  [decision records](https://github.com/RAESystem/env-packs/blob/main/docs/decisions/adrs/README.md).
