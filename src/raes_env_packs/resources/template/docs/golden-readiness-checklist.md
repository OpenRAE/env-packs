...
- [ ] Every required RAES objective, flag, and success condition is reached from the intended participant privilege context.
...
- [ ] The human walkthrough and automated rehearsal exercise the same declared RAES behavior and objectives.
