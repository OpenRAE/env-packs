...
The full TechVault SDL and its tracked content were migrated from APTL
`origin/dev` at commit `3db5171f3e4add842efd1d81fa0d4fe078511b7e`.
APTL remains a backend consumer; this pack is the editable authority for the
scenario's distributable content.
...
APTL's tracked workstation fixture omitted
